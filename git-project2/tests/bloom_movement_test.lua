...
if old_file then
  ...
  for frame = 1, 300 do
    ...
    local a, b = old.choose(world(p, objects), previous, config()), dodge.choose(world(p, objects), current, config(), nil)
  ...
  print("PASS nil-intent vs unedited baseline: 300 scenes")
end
