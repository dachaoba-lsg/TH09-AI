...
$requiredPackageFiles = @('README.md', 'LICENSE.txt', 'VERSION.txt', 'launcher-settings.json',
    ($playerGuide + '.txt'), ($releaseNotes + '.md'), ($difficultyGuide + '.md'),
...
& (Join-Path $project 'build-package.ps1') -Version $Version -Overwrite:$Overwrite -PackageName $PackageName -ZipBase $ZipBase
