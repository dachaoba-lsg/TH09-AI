...
& $CompilerPath -shared -Wall -Werror -o (Join-Path $runtime 'window_support.dll') (Join-Path $native 'window_resize.c') (Join-Path $native 'window_support.c') (Join-Path $native 'practice_patches.c') (Join-Path $native 'laser_sensor.c') (Join-Path $native 'player_sensor.c') -luser32 -lkernel32
...
Write-Output 'Native build, owned-window, laser-sensor and player-sensor tests passed.'
